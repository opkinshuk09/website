                            ...
                            <ul>
                              <li>
                                    <a href="skin?id=normal">
                                        <span class="title">Normal Skin</span>
                                    </a>
                                </li>
                                <li>
                ...
                <li>
                    ...
                    <ul>
                            ...
                            <a href="generator.php">
                                <span class="title">Premium Generator</span>
                            </a>
                                </li>
                                <li>
                            <a href="privategen">
                                <span class="title">Private Generator</span>
                            </a>
                                </li>
                                <li>
                            <a href="history">
                                <span class="title">Generations History</span>
                            </a>
                        </li>                                <li>
                            <a href="allacc">
            ...
            echo '
                ...
                <li>
                        ...
                        <li class="opened">
                            <a href="#">
                                <i class="entypo-flow-line"></i>
                                <span class="title">Administration Level II</span>
                            </a>
                            <ul>
                                <li>
                                    <a href="admin-manageII">
                                        <i class="entypo-flow-parallel"></i>
                                        <span class="title">Manage Alts</span>
                                    </a>
                                </li>
                                                                <li>
                                    <a href="admin-subscriptionsII">
                                        <i class="entypo-flow-parallel"></i>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <ul class="dropdown-menu-list scroller">
                                    ...
                                    $date = $row['date'];
                                    $msg = "You have a new reply from admins, check it!";
                                    $tickettt = $row['idticket'];
                                    echo
                                    '
                                    <li class="active">
                            ...
                            <li class="external">
                                <a href="admin-support">All Messages</a>
                            </li>
                        </ul>
