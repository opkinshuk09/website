...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<p class="description">Enter your email to receive an email on resetting your password.</p>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<form method="post" role="form" id="form_forgot_password">
				...
				<div class="form-forgotpassword-success" id="success-forgot">
					<i class="entypo-check"></i>
					<h3>Reset email has been sent.</h3>
					<p>Please check your email(check spam), reset password link will expire in 24 hours.</p>
				</div>
				
				<div class="form-login-error" id="unknown">
					<h3>An error occurred.</h3>
					<p>We could not find your email address in our database !</p>
				</div>

				<div class="form-login-error" id="problem">
					<h3>An error occurred.</h3>
					<p>We could not find your email address in our database !</p>
				</div>
