...
function time_ago( $date )
{
    ...
    $periods = array("seconde", "minute", "heure", "jour", "semaine", "mois", "année", "décénnie");
...
<head>
	...
	<title><?php echo $website ?> | Tableau de bord</title>
		...
		<hr />
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-green">
					...
					<h3>Total Générateurs</h3>
					<p>il y a beaucoup de générateurs.</p>
				</div>
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-aqua">
					...
					<h3>Générations</h3>
					<p>Nombre total des générations.</p>
				</div>
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-blue">
					...
					<h3>Abonnements</h3>
					<p>Sur le site en ce moment-même !</p>
				</div>
					...
					<div class="panel-heading">
						<div class="panel-title">
							<h4>
								Stats en temps réel
								<br /></br>
								<small>Disponibilité des serveurs actuellement</small>
							</h4>
						</div>
   ...
   if($subscription == "1" && $_SESSION['rank'] !== '5'){
	...
	<div class="col-sm-6">
				...
				<div class="panel panel-invert" data-collapsed="0"><!-- setting the attribute data-collapsed="1" will collapse the panel -->
					...
					<!-- panel head -->
					<div class="panel-heading">
						<div class="panel-title">Vos statistics</div>
					...
					<div class="panel-body">
						...
						<center><p style="font-size:20px;"><i class="entypo-trophy"></i> Votre Abonnement : ' . $packagename . '</p>
						<p style="font-size:20px;"><i class="entypo-cancel"></i>Prendra fin : ' .$paidexpire. '</p>
						<p style="font-size:20px;"><i class="entypo-lock"></i> Générations : '.$generations.' /day</p>
						<p style="font-size:20px;"><i class="entypo-cw"></i> Générations restantes : '.$todaygenerations.'</p>
						<p style="font-size:20px;"><i class="entypo-arrows-ccw"></i> Générations Totales : '.$allgenerations.'</p></br>
						</center>
					</div>
					</div>						
					</div>
		...
		<div class="col-md-6">
				...
				<div class="panel panel-invert" data-collapsed="0"><!-- setting the attribute data-collapsed="1" will collapse the panel -->
					...
					<div class="panel-body">
						...
						<center><p style="font-size:20px;"><i class="entypo-trophy"></i> Votre abonnement : Admin </p>
						<p style="font-size:20px;"><i class="entypo-lock"></i> Generations : Illimité</p>
						<p style="font-size:20px;"><i class="entypo-cw"></i> Generations restantes: Illimit</p>
						<p style="font-size:20px;"><i class="entypo-arrows-ccw"></i> Total Generations: '.$allgenerations.'</p></br></br>
						</center>
					</div>
					</div>						
					</div>
