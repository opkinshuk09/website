...
?>
		...
		<div style="display:flex;">
            <div class="col-md-6 well">
                        <legend>Envoyer un ticket</legend>
            <form method="POST"/>
            <label>Sujet:</label></br>
            <div class="fg-line">
            <input type="text" name="subject" class="form-control input-sm" placeholder="Votre sujet" maxlength="20" onkeyup="javascript:MaxLengthTextarea(this, 20);" required>
            </div></br>
            <label>Message:</label></br>

            <textarea name="message" class="form-control" rows="8" placeholder="Votre message" ></textarea></br>

            <button class="btn btn-blue btn-large btn-block ">Envoyer</button>
            </form>
                    </div>
					</div>
                        </div>
