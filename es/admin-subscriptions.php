...
<head>
	...
	<title><?php echo $website ?> | Suscripciones (Admin)</title>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">Crear una Nueva Suscripción</h4>
				</div>
			...
			$packagess = mysqli_query($con, "SELECT * FROM `package`");
				...
				<div class="modal-footer">
					...
					<button type="button submit" class="btn btn-primary">Añadir</button>
					</form>
					</div>
				</div>
			</div>
