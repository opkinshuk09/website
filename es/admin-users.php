...
<head>
	...
	<title><?php echo $website ?> | Usuarios (Admin)</title>
		...
		<table class="table table-bordered table-striped datatable" id="table-2">
			...
			<?php
					...
					if(mysqli_num_rows($usersquery) < 1){
							echo'
						<tr>
						<td><td><td><td><td><td><td><td>Nombra de membre: 0</td></td></td></td></td></td></td></td></tr>
						';
					}else{
						...
						$banned = '<b><font color="red">Si</font></b>';
						}
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">Editar el usuario n°'. $row['id'] .'</h4>
				</div>
...
<div class="modal fade" id="sample-modal-dialog-member">
		<div class="modal-dialog">
            ...
            <input type="text" name="add-username" class="form-control"  placeholder="Ej: blockBoo2k" required/></br>
			                <label>Contraseña :</label></br>
            <input type="password" name="add-password" class="form-control" placeholder="Ej: abc123" /></br>
			                <label>Email :</label></br>
            <input type="text" name="add-email" class="form-control"  placeholder="Ej: email@email.com" required/></br>
							<label>Rango :</label></br>
            <select name="add-rank" class="form-control" style="margin-bottom: 5px;" required>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
					<button type="button submit" class="btn btn-primary">Crear el Usuario</button>
					</form>
				</div>
			</div>
		</div>
