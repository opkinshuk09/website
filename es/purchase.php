...
<head>
	...
	<title><?php echo $website ?> | Comprar</title>
...
if($row['generations'] == ""){
$generations = '<font color="green">Illimitado</font>';
}else{
$generations = $row['generations']." /Hora";
}

if($row['privgenerations'] == ""){
$privgenerations = "Illimitado";
}else{
$privgenerations = $row['privgenerations']." /Hora";
}
...
$buy = " buy-three";
			...
			<div class="pricing-grid agileits-shadow" style="margin-bottom: 100px;">
				...
				<div class="agileinfo-price '. $infoprice .'">
					<h3>'. $name .'</h3>
					<h5>Serás premium por '. $donnee2[0] . ' '; if(!empty($donnee2[1])){ echo $donnee2[1];} echo '</h5>
				</div>
				<div class="price-bg">
					...
					<div class="buy'. $buy .'"> 
						<a href="#" onclick="myform'.$idpackage.'()" class="bg">Comprar Paquete </a>
					</div> </form>
				</div>
				</div>
