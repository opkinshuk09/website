...
<head>
	...
	<title><?php echo $website ?> | Historique</title>
...
<?php include 'include/header.php'; ?>
		...
		<h1 class="margin-bottom">Historique</h1>
					<ol class="breadcrumb 2" >
						...
						<li class="active">
									...
									<strong>Historique de générations</strong>
							</li>
							</ol>
		...
		<table class="table table-bordered datatable" id="table-3">
			...
			<tbody>
			<?php $log = mysqli_query($con, "SELECT * FROM `history` WHERE `username` = '$username' ORDER BY `date` DESC") or die(mysqli_error($con));
