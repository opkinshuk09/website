...
<div class="login-container">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="form-login-error" id="error-refcode">
				<h3>Huh...</h3>
				<p>Your <strong>referral code</strong> is incorrect !</p>
			</div>
					...
					<div class="step current" id="step-1">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="ref" id="ref" placeholder="Ref Code (additional)" value="<?php echo $ref; ?>"  autocomplete="off" <?php echo $read; ?> />
							</div>
						</div>
