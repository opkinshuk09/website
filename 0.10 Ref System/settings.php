...
$useruser = mysqli_real_escape_string($con, $_SESSION['username']);
$result = mysqli_query($con, "SELECT * FROM users WHERE username = '$useruser'") or die(mysqli_error($con));
...
$folder = substr($folder, 0, -12);
$folder = $folder."register";
...
<?php include 'include/header.php'; ?>
		...
		<form method="post" class="form-horizontal form-groups-bordered validate" action="settings">
			...
			<h3> Error </h3>
				<p> Your current password is not this ! </p>
			</div>
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<span class="description">You can not modify your username.</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<span class="description">You can not modify your email.</span>
								</div>
							</div>
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Ref code</label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" value="<?php  echo $http."://".$_SERVER['HTTP_HOST'].$folder."?ref=". urlencode($username)?>" readonly>
									<span class="description">Send this link to your friends.</span>
								</div>
							</div>
							<div class="form-group">
								<label for="field-1" class="col-sm-3 control-label">Ref users</label>
								
								<div class="col-sm-5">
									<input type="text" class="form-control" id="field-1" value="<?php echo $ref ?>" readonly>
								</div>
							</div>
				<hr />
							<div class="form-group">
								<label for="field-3" class="col-sm-3 control-label">Current password</label>
							...
							<div class="form-group">
								<label for="field-4" class="col-sm-3 control-label">New password</label>
...
$os = $row200['os'];
				...
				<tr class="odd gradeX">
					<td>'.$ip.'</td>
					<td>'.$date.'</td>
					<td class="center">Connected with '.$os.'</td>
				</tr>'; }?>	
			</tbody>
			<tfoot>
				<tr>
