					...
					neonRegister.setPercentage(98, function()
					{
						...
						$.ajax({
							...
							data: {
								...
								confpassword: $("input#confpassword").val(),
							},
								...
								setTimeout(function()
								{
									...
									neonRegister.$steps.slideUp('normal', function()
									{
										...
										if(register_status == 'invalid'){
												$("#error-inconnue").slideDown('normal');
										}else
										if(register_status == 'longueur'){
												$("#error-longueur").slideDown('normal');
										}else
										if(register_status == 'conf'){
												$("#error-conf").slideDown('normal');
										}else
										if(register_status == 'usertaken'){
												$("#error-usertaken").slideDown('normal');
										}else
										if(register_status == 'emailtaken'){
												$("#error-emailtaken").slideDown('normal');
										}else
										if(register_status == 'refcode'){
												$("#error-refcode").slideDown('normal');
										}
